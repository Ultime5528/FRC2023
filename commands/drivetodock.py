...
class _DriveToDock(SafeCommand):
    start_speed = autoproperty(0.25, subtable=DriveToDock.__name__)
    climbing_speed = autoproperty(0.2, subtable=DriveToDock.__name__)
    balancing_speed = autoproperty(0.0, subtable=DriveToDock.__name__)
    climbing_threshold = autoproperty(10.0, subtable=DriveToDock.__name__)
    ontop_threshold = autoproperty(3.0, subtable=DriveToDock.__name__)
